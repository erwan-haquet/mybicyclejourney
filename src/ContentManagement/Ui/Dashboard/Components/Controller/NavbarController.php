...
namespace App\ContentManagement\Ui\Dashboard\Components\Controller;
...
#[Route(
    '/_components/dashboard/navbar',
    name: 'dashboard_components_navbar',
...
class NavbarController extends AbstractController
{
    ...
    public function __invoke(
        ...
        return $this->render('dashboard/components/navbar/index.html.twig', [
            'navbar' => new Navbar([
