...
use App\Web\Ui\Public\Pages\Form\TheProject\RegisterEarlyBirdFormType;
...
class TheProjectController extends AbstractController
{
    ...
    ): Response
    {
        ...
        $form = $this->createForm(RegisterEarlyBirdFormType::class, $command);
        ...
        return $this->render('web/public/pages/the_project/index.html.twig', [
